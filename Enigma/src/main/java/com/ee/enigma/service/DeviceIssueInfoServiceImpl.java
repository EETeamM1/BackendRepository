...
public class DeviceIssueInfoServiceImpl implements DeviceIssueInfoService
{
  ...
  public EnigmaResponse deviceIssueInfoService(Request deviceIssueInfoRequest)
  {
    ...
    if (byAdmin)
    {
      response = createDeviceIssueInfoByAdmin(response, deviceIssueInfoList, deviceInfo, userId,
        deviceId, byAdmin);
    ...
    {
      response = createDeviceIssueInfoByUser(response, deviceIssueInfoList, deviceInfo, userId,
        deviceId, byAdmin);
      if (Constants.RETURN_REPONSE_UPDATED.equals(response.getReturnResponse()))
      {
        return response;
 ...
 //confirm first before junit
  ...
  public EnigmaResponse getDevicesIssueReportByStatus()
  {
    ...
    List<ReportInfo> jsonObjectList = deviceIssueHelper.buildDevicesListByStatus(
      deviceIssueInfoList, deviceInfoList);
  ...
  protected EnigmaResponse createDeviceIssueInfoByAdmin(
    EnigmaResponse response,
    List<DeviceIssueInfo> deviceIssueInfoList,
  ...
  protected EnigmaResponse createDeviceIssueInfoByUser(
    EnigmaResponse response,
    List<DeviceIssueInfo> deviceIssueInfoList,
    DeviceInfo deviceInfo,
    String userId,
  ...
  protected EnigmaResponse createDeviceSubmitByAdmin(
    EnigmaResponse response,
    List<DeviceIssueInfo> deviceIssueInfoList,
    DeviceInfo deviceInfo,
    String userId,
  ...
  protected EnigmaResponse createDeviceSubmitByUser(
    EnigmaResponse response,
    List<DeviceIssueInfo> deviceIssueInfoList,
    DeviceInfo deviceInfo,
    String userId,
