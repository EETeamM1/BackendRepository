...
public class DeviceReport {
    ...
    public EnigmaResponse getTopDevices() {
        ...
        if (null == topDeviceDtoList || topDeviceDtoList.isEmpty()) {
    ...
    public EnigmaResponse getDeviceReport(@QueryParam("deviceId") String deviceId,
        ...
        if (null == deviceReportDtoList || deviceReportDtoList.isEmpty()) {
            // Success response.
            CommonUtils.updateResponse(response, responseCode, "No Reports available for given Date",
